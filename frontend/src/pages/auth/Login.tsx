...
import { setAuthTokens, setAccount } from '../../store/slices/auth'; // Updated import
  ...
  const handleLogin = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    ApiService.post('auth/login', {
      ...
      .then((response) => {
        ...
        dispatch(setAuthTokens({ access_token: accessToken }));
    ...
    <>
      <div className="w-full grid grid-cols-5">
        <div className="col-span-3 order-1">
          ...
          <form onSubmit={handleLogin} className="px-10 py-10 mx-auto max-w-3xl space-y-6">
            <h3 className="text-5xl font-bold">Log in to your Linktree</h3>

            <div className="relative">
              <div className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-gray-500">
                linktr.ee/
              </div>
              <input
                required
                ...
                type="text"
                className="bg-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-20 p-4"
              />
            </div>
